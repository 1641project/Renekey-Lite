...
<template>
<div class="mk-app">
	<a v-if="root" href="https://github.com/taiyme/misskey" target="_blank" class="github-corner" aria-label="View source on GitHub">
