...
<div :class="$style.root">
	...
	<div :class="$style.middle">
		<MkA :class="$style.item" :active-class="$style.active" to="/" exact>
		...
		<template v-for="item in menu" :key="item">
			...
			<component :is="navbarItemDef[item].to ? 'MkA' : 'button'" v-else-if="navbarItemDef[item] && (navbarItemDef[item].show !== false)" class="_button" :class="[$style.item, { [$style.active]: navbarItemDef[item].active }]" :active-class="$style.active" :to="navbarItemDef[item].to" v-on="navbarItemDef[item].action ? { click: navbarItemDef[item].action } : {}">
		...
		<MkA v-if="$i!.isAdmin || $i!.isModerator" :class="$style.item" :active-class="$style.active" to="/admin">
		...
		<MkA :class="$style.item" :active-class="$style.active" to="/settings">
