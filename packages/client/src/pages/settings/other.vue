...
<div class="_gaps_m">
	...
	<!-- <FormSwitch v-model="reportError">
		<template #label>{{ i18n.ts.sendErrorReports }}</template>
		<template #caption>{{ i18n.ts.sendErrorReportsDescription }}</template>
	</FormSwitch> -->
...
// const onChangeInjectFeaturedNote = (v: boolean): void => {
// 	os.api('i/update', {
