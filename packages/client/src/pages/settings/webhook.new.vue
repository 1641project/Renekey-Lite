<template>
<div class="_formRoot">
	<FormInput v-model="name" :max-length="100" class="_formBlock">
		<template #label>Name</template>
	</FormInput>

	<FormInput v-model="url" :max-length="1024" type="url" class="_formBlock">
		<template #label>URL</template>
	</FormInput>

	<FormInput v-model="secret" :max-length="1024" class="_formBlock">
