...
<div v-if="meta" :class="$style.root">
	<div :class="[$style.main, $style.panel]">
		<img :src="instance.iconUrl || (instance as any).faviconUrl || '/favicon.ico'" alt="" :class="$style.mainIcon"/>
	...
	<div v-if="!instance.disableLocalTimeline" :class="[$style.tl, $style.panel]">
...
import { } from 'vue';
import { Instance, Stats } from 'misskey-js/built/entities';
...
let meta = $ref<Instance | null>(null);
...
const exploreOtherServers = (): void => {
	// TODO: 言語をよしなに
