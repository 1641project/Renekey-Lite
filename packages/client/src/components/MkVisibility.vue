...
<span v-if="note.localOnly" :class="$style.localOnly" :title="i18n.ts._visibility.disableFederation"><i class="ti ti-rocket-off"></i></span>
...
const showRecipients = async (): Promise<void> => {
	os.popup(defineAsyncComponent(() => import('@/components/TmsUserIdsDialog.vue')), {
